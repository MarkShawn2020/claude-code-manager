...
如果你正在使用 Claude Code 进行 AI 辅助编程，那么 Claude Code Manager（简称 ccm）将是你的最佳伴侣。今天，我们发布了 v2.9.0 版本，带来了备受期待的多状态栏支持功能。

### 🆕 本次更新亮点

**多状态栏支持** - 现在你可以根据个人喜好自由切换不同风格的状态栏显示：

- **vibe-genius**: 全功能版，显示所有开发指标，适合需要详细信息的开发者
- **vibe-genius-wind**: 随机表情版，每次执行都有不同的emoji，让开发过程更有趣
...
*Claude Code Manager - 让 AI 编程更高效、更透明、更有趣！*